"""
Django settings for testmvp_45693 project.
...
ROOT_URLCONF = 'testmvp_45693.urls'
...
WSGI_APPLICATION = 'testmvp_45693.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testmvp_45693 API",
    "DESCRIPTION": "API documentation for testmvp_45693 App",
    "VERSION": "v1",
}
